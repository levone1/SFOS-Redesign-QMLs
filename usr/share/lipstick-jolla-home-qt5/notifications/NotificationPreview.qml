    ...
    Private.SwipeItem {
        ...
        Rectangle {
            ...
            property color _color: popupArea.palette.colorScheme == Theme.LightOnDark
                                   ? Qt.tint("#121518", Theme.rgba(Theme.highlightDimmerColor, 0.85))
                                   : Qt.tint("#121518", Theme.rgba(Theme.highlightDimmerColor, 0.85))
            ...
            border.color: Qt.tint(_color, Theme.rgba(Theme.secondaryHighlightColor, 0.9))
            opacity: 0.85
                ...
                Row {
                    ...
                    Label {
                        ...
                        width: popupArea.expanded
                               ...
                               : implicitWidth
                        color: popupArea.down ? "#dadada"
                                              : (popupArea.expanded ? "#dadada"
                                                                    : "#dadada")
