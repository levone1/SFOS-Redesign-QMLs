...
EditableGridDelegate {
    ...
    property real coverOpacity: hideCover ? 0.0 : (!running ? Theme.opacityHigh : 0.75)
    ...
    Rectangle {
        color: quickSwitchingApp ? Theme.highlightBackgroundColor : isLightTheme ?  Theme.darkPrimaryColor : Theme.highlightBackgroundColor
        anchors.fill: parent
